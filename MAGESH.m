...
folder = fileparts(which('C:\Users\Lakshmi\Downloads\sarimg.png')); % Determine where demo folder is (works with all versions).
baseFileName = 'C:\Users\Lakshmi\Downloads\sarimg.png';
